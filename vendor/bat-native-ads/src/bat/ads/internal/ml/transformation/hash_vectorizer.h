...
#ifndef BAT_ADS_INTERNAL_ML_TRANSFORMATION_HASH_VECTORIZER_H_
#define BAT_ADS_INTERNAL_ML_TRANSFORMATION_HASH_VECTORIZER_H_
...
#endif  // BAT_ADS_INTERNAL_ML_TRANSFORMATION_HASH_VECTORIZER_H_
