...
class DomainBlockTest : public AdBlockServiceTest {
 public:
  DomainBlockTest() {}
 ...
 private:
  DISALLOW_COPY_AND_ASSIGN(DomainBlockTest);
};
...
IN_PROC_BROWSER_TEST_F(DomainBlockTest, NoFetch) {
  ...
  TestingBrowserProcess::GetGlobal()->SetSharedURLLoaderFactory(old_factory);
}
